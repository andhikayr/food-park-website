...
<div class="row">
    <div class="col-lg-12">
        <div class="d-flex align-items-center mb-3">
            <h6 class="mb-0 text-uppercase">Edit Kategori Produk</h6>
            <div class="ms-auto">
                <div class="btn-group">
                    ...
                    <form method="POST" class="row g-3" action="{{ route('admin.product-category.update', $productCategory->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="name"
                                name="name" required maxlength="255" value="{{ $productCategory->name }}">
                        </div>
                        <div class="col-md-6">
                            <label for="status" class="form-label">Status</label>
                            <select name="status" id="status" class="form-select">
                                <option value="1" @selected($productCategory->status === 1)>Aktif</option>
                                <option value="0" @selected($productCategory->status === 0)>Tidak Aktif</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="show_at_home" id="show_at_home" class="form-select">
                                <option value="1" @selected($productCategory->show_at_home === 1)>Ya</option>
                                <option value="0" @selected($productCategory->show_at_home === 0)>Tidak</option>
                            </select>
                        </div>
