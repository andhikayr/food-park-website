                        ...
                        <div class="exzoom_img_box fp__menu_details_images">
                            <ul class='exzoom_img_ul'>
                                <li><img class="zoom ing-fluid w-100"
                                        src="{{ asset('admin/uploads/product_image/' . $product->thumb_image) }}"
                                        alt="product"></li>
                                @foreach ($product->productImages as $image)
                                    <li><img class="zoom ing-fluid w-100"
                                            src="{{ asset('admin/uploads/product_image/' . $image->image) }}"
                                            alt="product"></li>
                                @endforeach
                            </ul>
                        </div>
                                    ...
                                    <div class="fp__menu_item_text">
                                        ...
                                        <h5 class="price">
                                            @if ($relatedProduct->offer_price > 0)
                                                ...
                                                <del>Rp. {{ number_format($relatedProduct->price, 0, ',', '.') }}</del>
                                            @else
